...
namespace MusicPlayerTokenDealer
{
    public partial class frmCopyleftTokenSettings : Form
    {
        ...
        public frmCopyleftTokenSettings()
        {
         ...
         public frmCopyleftTokenSettings(Form callingForm)
        {
        ...
        private void FillClient()
        {
            ...
            sQr = sQr + " where  Users.musictype<>'Copyright' and AMPlayerTokens.IsDam=1 and Users.clientId=" + StaticClass.DfClient_Id;
