...
{
    public partial class frmTokenDistributionCopyleft : Form
    {
        ...
        public frmTokenDistributionCopyleft()
        {
            InitializeComponent();
        }
         private frmDealerAdministrator mainForm = null;
         public frmTokenDistributionCopyleft(Form callingForm)
        {
        ...
        private void frmTokenDistributionCopyleft_Load(object sender, EventArgs e)
        {
            ...
            sQrStr = sQrStr + " and AMPlayerTokens.IsDam=1 order by Users.UserID desc  ";
        ...
        private void ClearFields()
        {
            ...
            sQr = sQr + " and AMPlayerTokens.IsDam=1 order by Users.UserID desc  ";
            FillClient();
            dtpDamExpiryDate.Value = DateTime.Now.Date;
        ...
        private void SendEmailMainClientData()
        {
            try
            {
                ...
                body += "This email contains the information required for you to install Eufory Music Player. \n";
                body += "Please follow the instructions carefully for the best result. \n";
                body += "The installation is required to be done in Internet Explorer/Chrome. \n";
                body += "1) Click on the link and follow the instructions :";
                if (IsDam == 1)
                {
                    body += " http://eufory.org/musicplayer/DAM/publish.htm \n";
